...
function Update()
   ...
   if mouseState == 'Off' then
      SKIN:Bang('!HideMeter', 'MeterText4')
      MouseOff()
   end
...
function MouseOver()
   ...
   if currentPos >= overStart and currentPos < overEnd then
      ...
      SKIN:Bang('!SetOption', 'MeterImage4', 'ImageName', currentPos..'.png')
      SKIN:Bang('!UpdateMeter', '*')
      SKIN:Bang('!Redraw')
   else
      SKIN:Bang('!ShowMeter', 'MeterText4')
      SKIN:Bang('!DisableMeasure', 'MeasureAnimScript4')
   end
