...
function Update()
   ...
   if mouseState == 'Off' then
      SKIN:Bang('!HideMeter', 'MeterText2')
      MouseOff()
   end
...
function MouseOver()
   ...
   if currentPos >= overStart and currentPos < overEnd then
      ...
      SKIN:Bang('!SetOption', 'MeterImage2', 'ImageName', currentPos..'.png')
      SKIN:Bang('!UpdateMeter', '*')
      SKIN:Bang('!Redraw')
   else
      SKIN:Bang('!ShowMeter', 'MeterText2')
      SKIN:Bang('!DisableMeasure', 'MeasureAnimScript2')
   end
