...
function Update()
   ...
   if mouseState == 'Off' then
      SKIN:Bang('!HideMeter', 'MeterText6')
      MouseOff()
   end
...
function MouseOver()
   ...
   if currentPos >= overStart and currentPos < overEnd then
      ...
      SKIN:Bang('!SetOption', 'MeterImage6', 'ImageName', currentPos..'.png')
      SKIN:Bang('!UpdateMeter', '*')
      SKIN:Bang('!Redraw')
   else
      SKIN:Bang('!ShowMeter', 'MeterText6')
      SKIN:Bang('!DisableMeasure', 'MeasureAnimScript6')
   end
