...
function Update()
   ...
   if mouseState == 'Off' then
      SKIN:Bang('!HideMeter', 'MeterText3')
      MouseOff()
   end
...
function MouseOver()
   ...
   if currentPos >= overStart and currentPos < overEnd then
      ...
      SKIN:Bang('!SetOption', 'MeterImage3', 'ImageName', currentPos..'.png')
      SKIN:Bang('!UpdateMeter', '*')
      SKIN:Bang('!Redraw')
   else
      SKIN:Bang('!ShowMeter', 'MeterText3')
      SKIN:Bang('!DisableMeasure', 'MeasureAnimScript3')
   end
