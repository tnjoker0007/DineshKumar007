...
function Update()
   ...
   if mouseState == 'Off' then
      SKIN:Bang('!HideMeter', 'MeterText5')
      MouseOff()
   end
...
function MouseOver()
   ...
   if currentPos >= overStart and currentPos < overEnd then
      ...
      SKIN:Bang('!SetOption', 'MeterImage5', 'ImageName', currentPos..'.png')
      SKIN:Bang('!UpdateMeter', '*')
      SKIN:Bang('!Redraw')
   else
      SKIN:Bang('!ShowMeter', 'MeterText5')
      SKIN:Bang('!DisableMeasure', 'MeasureAnimScript5')
   end
